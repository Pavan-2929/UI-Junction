        ...
        >
          ...
          <div className="flex space-x-4">
              <div className="flex flex-col w-1/2">
                <label htmlFor="firstname" className="text-yellow-600">
                  First Name
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col w-1/2">
                <label htmlFor="lastname" className="text-yellow-600">
                  Last Name
                </label>
                <input
                  type="text"
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col">
              <label htmlFor="confirmPassword" className="text-yellow-700">
                confirm Password
              </label>
              <input
                type="password"
